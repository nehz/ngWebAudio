...
.factory('WebAudio', ['$rootScope', 'deferredApply', function ($rootScope, deferredApply) {
    ...
    var audioBuffers = {}, eventHandlers = {}, xmlRequestOptions= {};
    ...
    function bufferAudio(src, retryInterval) {
        ...
        req.open(xmlRequestOptions.method||"GET", src, true);
        ...
        req.send(xmlRequestOptions.FormData ? xmlRequestOptions.FormData(): {});
    }
    ...
    var WebAudio = function WebAudio(src, options,xmlOptions) {
        if (!(this instanceof WebAudio)) return new WebAudio(src, options, xmlOptions);
        if (!eventHandlers[src]) eventHandlers[src] = {};

        options = options || {};
        xmlRequestOptions = xmlOptions || {};
        ...
        ctor(this, src, options,xmlOptions);
